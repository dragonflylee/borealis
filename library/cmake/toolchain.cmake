...
elseif(PLATFORM_PS5)
    ...
    if (NOT CMAKE_TOOLCHAIN_FILE)
        message(FATAL_ERROR "Native PS5 builds require an explicit native toolchain")
    endif ()
    set(USE_GL3 ON)
    add_definitions(-DPS5 -D__PS5__ -DPS5_NATIVE_GPU)
elseif (PLATFORM_SWITCH)
    ...
    set(CMAKE_C_FLAGS "-D__SWITCH__ -I${DEVKITPRO}/libnx/include -I${DEVKITPRO}/portlibs/switch/include")
